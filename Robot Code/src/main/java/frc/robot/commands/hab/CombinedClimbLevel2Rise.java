...
public class CombinedClimbLevel2Rise extends Command {
  ...
  public CombinedClimbLevel2Rise() {
  ...
  protected void execute() {
    ...
    double rkHt = Math.max(RobotMap.CargoIntake.INTAKE_HEIGHT_LEVEL_2_START - mCargoIntake.getFrontWheelHeight(), 0);
  ...
  protected boolean isFinished() {
    return mHab.getRackHeight() >= RobotMap.Hab.PLATFORM_2_HEIGHT + RobotMap.Hab.PLATFORM_CLIMB_TOLERANCE;
  }
