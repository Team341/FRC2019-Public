...
public class HabClimbLevel3 extends CommandGroup {
  /**
   * Add your docs here.
   */
  public HabClimbLevel3() {
    // Add Commands here:
    ...
    addSequential(new CombinedClimbLevel3Rise());
    ...
    */
    ...
    addSequential(new CargoIntakeSetPosition(RobotMap.CargoIntake.HINGE_CLIMB_POSITION));
    // addSequential(new HabExtendRackDistance(RobotMap.Hab.PLATFORM_3_HEIGHT));
